...
ATTACHMENT_ALLOWED = {".pdf", ".xlsx", ".xls", ".csv", ".txt", ".png", ".jpg", ".jpeg", ".gif", ".webp", ".docx", ".doc", ".zip", ".fasta", ".fastq", ".fna", ".fq", ".fa", ".ab1", ".gbk", ".gff", ".vcf", ".bam", ".sam", ".nwk", ".newick", ".tree", ".bed", ".gz", ".tar", ".tgz"}
